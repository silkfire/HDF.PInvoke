...
public partial class H5ATest
{
    ...
    {
        Assert.False(H5A.write(Utilities.RandomInvalidHandle(), Utilities.RandomInvalidHandle(), nint.Zero) >= 0);
        Assert.False(H5A.write(Utilities.RandomInvalidHandle(), H5T.NATIVE_DOUBLE, nint.Zero) >= 0);
    }
}
