...
public partial class H5STest
{
    ...
    public void H5Sget_simple_extent_npointsTest1()
    {
        ...
        Assert.True(space >= 0);
        Assert.True(H5S.get_simple_extent_npoints(space) == 6);
    ...
    public void H5Sget_simple_extent_npointsTest2()
    {
        ...
        Assert.True(space >= 0);
        Assert.True(H5S.get_simple_extent_npoints(space) == 0);
        Assert.True(H5S.close(space) >= 0);
    }
    ...
    public void H5Sget_simple_extent_npointsTest3()
    {
        ...
        Assert.True(space >= 0);
        Assert.True(H5S.get_simple_extent_npoints(space) == 1);
        Assert.True(H5S.close(space) >= 0);
    }
    ...
    {
        Assert.False(H5S.get_simple_extent_npoints(Utilities.RandomInvalidHandle()) >= 0);
    }
}
