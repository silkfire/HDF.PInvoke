...
{
    [Fact]
    public void H5Lget_val_by_idxTest()
    {
        ...
        Assert.True(H5L.create_soft(symPathStringPtr, m_v0_test_file, abcd1StringPtr, H5LFixture.m_lcpl) >= 0);
        Assert.True(H5L.create_soft(symPathStringPtr, m_v0_test_file, abcd2StringPtr, H5LFixture.m_lcpl) >= 0);

        H5L.info_t info = new H5L.info_t();
        Assert.True(H5L.get_info(m_v0_test_file, abcd2StringPtr, ref info) >= 0);
        ...
        Assert.True(H5L.get_val_by_idx(m_v0_test_file, abcStringPtr, H5.index_t.NAME, H5.iter_order_t.NATIVE, 2, hnd.AddrOfPinnedObject(), new nint(buf.Length)) >= 0);
        ...
        Assert.True(H5L.create_soft(symPathStringPtr, m_v2_test_file, abcd1StringPtr, H5LFixture.m_lcpl) >= 0);
        Assert.True(H5L.create_soft(symPathStringPtr, m_v2_test_file, abcd2StringPtr, H5LFixture.m_lcpl) >= 0);
        ...
        Assert.True(H5L.get_val_by_idx(m_v2_test_file, abcStringPtr, H5.index_t.NAME, H5.iter_order_t.NATIVE, 2, hnd.AddrOfPinnedObject(), new nint(buf.Length)) >= 0);
