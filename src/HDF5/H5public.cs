...
public sealed partial class H5
{
    ...
    /// <summary>
    /// Storage info struct used by <see cref="H5O.info_t"/> and <see cref="H5F.info_t"/>.
    /// </summary>
    ...
    /// </summary>
    /// <param name="reg_global_lim">The cumulative limit, in bytes, on memory used for all regular free lists.<para>The default is 1MB.</para></param>
    /// <param name="reg_list_lim">The limit, in bytes, on memory used for each regular free list.<para>The default is 64KB.</para></param>
    /// <param name="arr_global_lim">The cumulative limit, in bytes, on memory used for all array free lists.<para>The default is 4MB.</para></param>
    /// <param name="arr_list_lim">The limit, in bytes, on memory used for each array free list.<para>The default is 256KB.</para></param>
    /// <param name="blk_global_lim">The cumulative limit, in bytes, on memory used for all block free lists and, separately, for all factory free lists.<para>The default is 16MB.</para></param>
    /// <param name="blk_list_lim">The limit, in bytes, on memory used for each block or factory free list.<para>The default is 1MB.</para></param>
    /// <returns> Returns a non-negative value if successful; otherwise returns a negative value.</returns>
