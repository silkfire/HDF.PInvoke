...
public sealed partial class H5G
{
    ...
    public static hid_t create(hid_t loc_id, nint name) => create(loc_id, name, H5P.DEFAULT, H5P.DEFAULT, H5P.DEFAULT);
    ...
    /// <returns>Returns a group identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t create(hid_t loc_id, nint name, hid_t lcpl_id) => create(loc_id, name, lcpl_id, H5P.DEFAULT, H5P.DEFAULT);
    ...
    /// <returns>Returns a group identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t create(hid_t loc_id, nint name, hid_t lcpl_id, hid_t gcpl_id) => create(loc_id, name, lcpl_id, gcpl_id, H5P.DEFAULT);
