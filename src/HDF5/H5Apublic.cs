...
public sealed partial class H5A
{
    ...
    /// <summary>
    /// Information struct for attribute (for <see cref="get_info"/>/<see cref="H5A.get_info_by_idx(long,nint,H5.index_t,H5.iter_order_t,ulong,ref info_t,long)"/>).
    /// </summary>
    ...
    /// <summary>
    /// Delegate for <see cref="iterate"/> callbacks.
    /// <para>See <see href="https://support.hdfgroup.org/HDF5/doc/RM/RM_H5A.html#Annot-Iterate2" /> for further reference.</para>
    /// </summary>
    /// <param name="location_id">The location identifier for the group or dataset being iterated over.</param>
    /// <param name="attr_name">The name of the current object attribute.</param>
    /// <param name="ainfo">The attribute's <see cref="info_t"/> struct.</param>
    /// <param name="op_data">A pointer referencing operator data passed to <see cref="iterate"/>.</param>
    /// <returns>Valid return values from an operator and the resulting <see cref="iterate"/> and op behavior are as follows:
    /// <para>Zero causes the iterator to continue, returning zero when all attributes have been processed.</para>
    /// <para>A positive value causes the iterator to immediately return that positive value, indicating short-circuit success. The iterator can be restarted at the next attribute, as indicated by the return value of <c>n</c>.</para>
    /// <para>A negative value causes the iterator to immediately return that value, indicating failure. The iterator can be restarted at the next attribute, as indicated by the return value of <c>n</c>.</para>
    /// </returns>
    ...
    /// <returns>Returns an attribute identifier if successful; otherwise returns a negative value.</returns>
    ...
    /// </summary>
    /// <param name="loc_id">Identifier of the dataset, group, or named datatype to have the attribute deleted from.</param>
    ...
    /// <returns>Returns an identifier for the attribute's creation property list if successful. Otherwise returns a negative value.</returns>
    ...
    /// </summary>
    /// <param name="loc_id">Location of object to which attribute is attached.</param>
    /// <param name="obj_name">Name of object to which attribute is attached, relative to location.</param>
    /// <param name="idx_type">Type of index.</param>
    /// <param name="order">Index traversal order.</param>
    /// <param name="n">Attribute's position in index.</param>
    /// <param name="ainfo">Struct containing returned attribute information.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    ...
    /// </summary>
    /// <param name="attr_id">Identifier of the attribute.</param>
    /// <param name="buf_size">The size of the buffer to store the name in.</param>
    /// <param name="name">Buffer to store name in.</param>
    /// <returns>Returns the length of the attribute's name, which may be longer than <paramref name="buf_size"/>, if successful. Otherwise returns a negative value.</returns>
    ...
    /// <returns>Returns attribute name size, in bytes, if successful; otherwise returns a negative value.</returns>
    ...
    /// <returns>Returns attribute dataspace identifier if successful; otherwise returns a negative value.</returns>
    ...
    /// <returns>Returns the amount of storage size allocated for the attribute; otherwise returns 0 (zero).</returns>
    ...
    /// </summary>
    /// <param name="obj_id">Identifer for object to which attribute is attached.</param>
    ...
    /// <summary>
    /// Opens an attribute for an object specified by attribute index position.
    ...
    /// </summary>
    /// <param name="loc_id">Location from which to find object to which attribute is attached.</param>
    /// <param name="obj_name">Name of object to which attribute is attached, relative to <paramref name="loc_id"/>.</param>
    /// <param name="attr_name">Name of attribute to open.</param>
    /// <returns>Returns an attribute identifier if successful; otherwise returns a negative value.</returns>
    ...
    /// <param name="type_id"> Identifier of the attribute datatype (in memory).</param>
    ...
    /// </summary>
    /// <param name="loc_id">Location or object identifier; may be dataset or group.</param>
    /// <param name="obj_name">Name of object, relative to location, whose attribute is to be renamed.</param>
