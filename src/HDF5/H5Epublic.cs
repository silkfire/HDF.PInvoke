...
public sealed partial class H5E
{
    ...
    /// <summary>
    /// A data structure describing an error.
    /// </summary>
    ...
    /// <summary>
    /// Callback for <see cref="walk"/>.
    /// </summary>
    /// <param name="n">Indexed position of the error in the stack.</param>
    /// <param name="err_desc">Reference to an <see cref="error_t"/> data structure describing the error.</param>
    /// <param name="client_data">Pointer to client data in the format expected by the user-defined function.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate herr_t walk_t(uint n, nint err_desc, ssize_t client_data);

    /// <summary>
    /// Specifies stack walking direction.
    /// </summary>
    public enum direction_t
    {
        /// <summary>
        /// Begin with the most specific error and end at the API = 0
        /// </summary>
        H5E_WALK_UPWARD = 0,

        /// <summary>
        /// Start at the API and end at the innermost function where the error was first detected = 1
        /// </summary>
        H5E_WALK_DOWNWARD = 1
    }
    ...
    /// <param name="is_stack">A flag indicating which error stack typedef the specified error stack conforms to.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eauto_is_v2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t auto_is_v2(hid_t estack_id, ref uint is_stack);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eclear2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eclose_msg"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="estack_id">Error stack identifier.</param>
    /// <returns>Returns a non-negative value on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eclose_stack"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a message identifier on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Ecreate_msg"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial hid_t create_msg(hid_t cls, type_t msg_type, nint msg);
    ...
    /// </summary>
    /// <returns>Returns an error stack identifier on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Ecreate_stack"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eget_auto2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical] [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="size">The length of class name to be returned by this function.</param>
    /// <returns>Returns non-negative value as on success; otherwise returns negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eget_class_name"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ssize_t get_class_name(hid_t class_id, nint name, size_t size);
    ...
    /// </summary>
    /// <returns>Returns an error stack identifier on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eget_current_stack"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="size">The length of error message to be returned by this function.</param>
    /// <returns>Returns the size of the error message in bytes on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eget_msg"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ssize_t get_msg(hid_t msg_id, ref type_t msg_type, nint msg, size_t size);
    ...
    /// <param name="estack_id">Error stack identifier.</param>
    /// <returns>Returns a non-negative value on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eget_num"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Epop"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eprint2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t print(hid_t estack_id, ssize_t stream);
    ...
    /// </summary>
    /// <param name="estack_id">Identifier of the error stack to which the error record is to be pushed. If the identifier is <see cref="DEFAULT"/>, the error record will be pushed to the current stack.</param>
    /// <param name="file">Name of the file in which the error was detected.</param>
    /// <param name="func">Name of the function in which the error was detected.</param>
    /// <param name="line">Line number within the file at which the error as detected.</param>
    /// <param name="class_id">Error class identifier.</param>
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Epush2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t push(hid_t estack_id, nint file, nint func, uint line, hid_t class_id, hid_t major_id, hid_t minor_id, nint msg);
    ...
    /// <param name="lib_name">Name of the client library or application to which the error class belongs.</param>
    /// <param name="version">Version of the client library or application to which the error class belongs. A <c>NULL</c> can be passed in.</param>
    /// <returns>Returns a class identifier on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eregister_class"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial hid_t register_class(nint cls_name, nint lib_name, nint version);
    ...
    /// <returns>Returns a non-negative value on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eset_auto2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="estack_id">Error stack identifier.</param>
    /// <returns>Returns a non-negative value on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eset_current_stack"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="class_id">Error class identifier.</param>
    /// <returns>Returns a non-negative value on success; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Eunregister_class"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
