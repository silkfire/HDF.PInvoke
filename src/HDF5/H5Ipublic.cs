...
public sealed class H5I
{
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-ClearType
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iclear_type",
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-DecRef
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Idec_ref",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-DecTypeRef
    /// </summary>
    ...
    /// on failure.</returns>
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Idec_type_ref",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-DestroyType
    /// </summary>
    /// <param name="type">Identifier of identifier type which is to be
    /// destroyed</param>
    /// <returns>Returns non-negative on success, negative on failure.</returns>
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Idestroy_type",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-GetFileId
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iget_file_id",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-GetName
    /// </summary>
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-GetRef
    /// </summary>
    /// <param name="obj_id">Object identifier whose reference count will
    /// be retrieved.</param>
    ...
    /// returned.</returns>
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iget_ref",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-GetType
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iget_type",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-GetTypeRef
    /// </summary>
    /// <param name="type">The identifier of the type whose reference count
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-IncRef
    /// </summary>
    /// <param name="obj_id">Object identifier whose reference count will
    /// be modified.</param>
    ...
    /// returned.</returns>
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iinc_ref",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-IncTypeRef
    /// </summary>
    /// <param name="type">The identifier of the type whose reference count
    /// is to be incremented</param>
    /// <returns>Returns the current reference count on success, negative
    /// on failure.</returns>
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iinc_type_ref",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-IsValid
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iis_valid",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-NMembers
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Inmembers",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-ObjectVerify
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iobject_verify",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    public static extern ssize_t object_verify
        (hid_t id, type_t id_type);

    /// <summary>
    /// Creates and returns a new ID.
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-Register
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iregister",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    public static extern hid_t register(type_t type, ssize_t obj);

    /// <summary>
    /// Creates and returns a new ID type.
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-RegisterType
    /// </summary>
    ...
    /// failure.</returns>
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iregister_type",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-RemoveVerify
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Iremove_verify",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    public static extern ssize_t remove_verify
        (hid_t id, type_t id_type);

    /// <summary>
    /// Finds the memory referred to by an ID within the given ID type such
    /// that some criterion is satisfied.
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-Search
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Isearch",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    public static extern ssize_t search
        (type_t type, search_func_t func, ssize_t key);

    /// <summary>
    /// Determines whether an identifier type is registered.
    /// See https://docs.hdfgroup.org/archive/support/HDF5/doc/RM/RM_H5I.html#Identify-TypeExists
    /// </summary>
    ...
    [DllImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Itype_exists",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
