...
public sealed class H5DO
{
    ...
    [DllImport(Constants.HighLevelApisDllFilename, EntryPoint = "H5DOread_chunk",
    ...
    /// <returns>Returns a non-negative value if successful; otherwise
    /// returns a negative value.</returns>
    [DllImport(Constants.HighLevelApisDllFilename, EntryPoint = "H5DOwrite_chunk",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise
    /// returns a negative value.</returns>
    [DllImport(Constants.HighLevelApisDllFilename, EntryPoint = "H5DOappend",
               CallingConvention = CallingConvention.Cdecl),
     SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    public static extern herr_t append
    (hid_t dset_id, hid_t dxpl_id, uint axis,
     size_t num_elem, hid_t memtype, size_t buf);
}
