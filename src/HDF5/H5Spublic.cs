...
public sealed unsafe partial class H5S
{
    ...
    public enum sel_type
    {
        ...
        /// <summary>
        /// No selection is defined = 0
        /// </summary>
        NONE = 0,

        /// <summary>
        /// A sequence of points is selected = 1
        /// </summary>
        POINTS = 1,

        /// <summary>
        /// A hyperslab or compound hyperslab is selected = 2
        /// </summary>
        HYPERSLABS = 2,

        /// <summary>
        /// The entire dataset is selected = 3
        /// </summary>
        ALL = 3,
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sclose"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Scopy"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a dataspace identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Screate"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="maxdims">Array specifying the maximum size of each dimension.</param>
    /// <returns>Returns a dataspace identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Screate_simple"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial hid_t create_simple(int rank, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] hsize_t[] dims, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] hsize_t[] maxdims);
    ...
    /// <returns>Returns an object ID(non-negative) if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sdecode"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="nalloc">The size of the allocated buffer or the size of the buffer needed.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sencode"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    /// which the extent is copied.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sextent_copy"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t extent_copy(hid_t dest_space_id, hid_t source_space_id);
    ...
    /// <returns>Returns 1 if equal, 0 if unequal, if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sextent_equal"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial htri_t extent_equal(hid_t space1_id, hid_t space2_id);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    /// <remarks>If a hyperslab selection is originally regular, then becomes irregular through selection operations, and then becomes regular again, the final regular selection may be equivalent but not identical to the original regular selection.</remarks>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_regular_hyperslab"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t H5Sget_regular_hyperslab(hid_t space_id, hsize_t[] start, hsize_t[] stride, hsize_t[] count, hsize_t[] block);
    ...
    /// <param name="end">Ending coordinates of the bounding box, i.e., the coordinates of the diagonally opposite corner.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    /// <remarks>The <paramref name="start"/> and <paramref name="end"/> buffers must be large enough to hold the dataspace rank number of coordinates.</remarks>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_bounds"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new System.Type[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_select_bounds(hid_t space_id, hsize_t[] start, hsize_t[] end);
    ...
    /// </summary>
    /// <param name="space_id">Identifier of dataspace to query.</param>
    /// <returns>Returns the number of points in the current dataspace point selection if successful. Otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_elem_npoints"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_elem_pointlist"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new System.Type[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_select_elem_pointlist(hid_t space_id, hsize_t startpoint, hsize_t numpoints, hsize_t[] buf);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_hyper_blocklist"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new System.Type[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_select_hyper_blocklist(hid_t space_id, hsize_t startblock, hsize_t numblocks, hsize_t[] buf);
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_hyper_nblocks"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns the number of elements in the selection if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_npoints"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// </summary>
    /// <param name="space_id">Dataspace identifier.</param>
    /// <returns>Returns the dataspace selection type, a value of the enumerated datatype <c>H5S.sel_type</c>, if successful. Otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_select_type"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_simple_extent_dims"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new System.Type[] { typeof(CallConvCdecl) })]
    public static partial int get_simple_extent_dims(hid_t space_id, hsize_t[] dims, hsize_t[] maxdims);
    ...
    /// <returns>Returns the number of dimensions in the dataspace if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_simple_extent_ndims"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_simple_extent_npoints"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// </summary>
    /// <param name="space_id">Dataspace identifier.</param>
    /// <returns>Returns a dataspace class name if successful; otherwise <see cref="class_t.NO_CLASS"/>.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sget_simple_extent_type"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns <c>TRUE</c> or <c>FALSE</c> for hyperslab selection if successful. Returns <c>FAIL</c> on error or when querying other selection types such as point selection.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sis_regular_hyperslab"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>When successful, returns a positive value, for <c>TRUE</c>, or 0 (zero), for <c>FALSE</c>. Otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sis_simple"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// </summary>
    /// <param name="space_id">The identifier for the dataspace object to reset.</param>
    /// <param name="offset">The offset at which to position the selection.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    /// <remarks>The offset array must be the same number of elements as the number of dimensions for the dataspace. If the offset array is set to <c>NULL</c>, the offset for the dataspace is reset to 0.</remarks>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Soffset_simple"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t offset_simple(hid_t space_id, [MarshalAs(UnmanagedType.LPArray)] hssize_t[] offset);
    ...
    /// </summary>
    /// <param name="dspace_id">The identifier for the dataspace for which the selection is being made.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sselect_all"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// </summary>
    /// <param name="space_id">Identifier of the dataspace.</param>
    /// <param name="op">Operator specifying how the new selection is to be combined with the existing selection for the dataspace.</param>
    /// <param name="num_elements">Number of elements to be selected.</param>
    /// <param name="coord">A pointer to a buffer containing a serialized copy of a 2-dimensional array of zero-based values specifying the coordinates of the elements in the point selection.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sselect_elements"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t select_elements(hid_t space_id, seloper_t op, size_t num_elements, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] coord);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sselect_hyperslab"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t select_hyperslab(hid_t space_id, seloper_t op, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] start, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] stride, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] count, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] block);
    ...
    /// </summary>
    /// <param name="space_id">The identifier for the dataspace in which the selection is being reset.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sselect_none"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a positive value, for <c>TRUE</c>, if the selection is contained within the extent or 0 (zero), for <c>FALSE</c>, if it is not. Returns a negative value on error conditions such as the selection or extent not being defined.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sselect_valid"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// </summary>
    /// <param name="space_id">The identifier for the dataspace from which the extent is to be removed.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sset_extent_none"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="current_size">Array containing current size of dataspace.</param>
    /// <param name="maximum_size">Array containing maximum size of dataspace.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Sset_extent_simple"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t set_extent_simple(hid_t space_id, int rank, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] current_size, [MarshalAs(UnmanagedType.LPArray)] hsize_t[] maximum_size);
}
