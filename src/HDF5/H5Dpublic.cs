...
public sealed unsafe partial class H5D
{
    ...
    /// <summary>
    /// Bit flags for <see cref="H5P.set_chunk_opts"/> and <see cref="H5P.get_chunk_opts"/>.
    /// </summary>
    public const uint DONT_FILTER_PARTIAL_CHUNKS = 0x0002u;

    public const string XFER_DIRECT_CHUNK_WRITE_FLAG_NAME = "direct_chunk_flag";
    public const string XFER_DIRECT_CHUNK_WRITE_FILTERS_NAME = "direct_chunk_filters";
    public const string XFER_DIRECT_CHUNK_WRITE_OFFSET_NAME = "direct_chunk_offset";
    public const string XFER_DIRECT_CHUNK_WRITE_DATASIZE_NAME = "direct_chunk_datasize";

    /// <summary>
    /// Values for the <c>layout</c> property.
    /// </summary>
    ...
    /// </summary>
    /// <param name="dataset_id">The dataset identifier.</param>
    /// <param name="cur_dims">The dataset’s current dimension sizes when a boundary is hit.</param>
    /// <param name="op_data">The user-defined input data.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate herr_t append_cb_t(hid_t dataset_id, hsize_t[] cur_dims, size_t op_data);

    /// <summary>
    /// Callback for <see cref="gather"/>.
    ...
    /// <para>This will always be identical to the <paramref name="dst_buf"/> passed to <see cref="gather"/>.</para></param>
    ...
    /// <summary>
    /// Delegate for <see cref="iterate"/> callback.
    /// <para>See <see href="https://support.hdfgroup.org/HDF5/doc/RM/RM_H5D.html#Dataset-Iterate" /> for further reference.</para>
    /// </summary>
    /// <param name="elem">Pointer to the memory buffer containing the current data element.</param>
    /// <param name="type_id">Datatype identifier for the elements stored in <paramref name="elem"/>.</param>
    /// <param name="ndim">Number of dimensions for the <paramref name="point"/> array.</param>
    /// <param name="point">Array containing the location of the element within the original dataspace.</param>
    /// <param name="op_data">Pointer to any user-defined data associated with the operation.</param>
    /// <returns>Zero causes the iterator to continue, returning zero when all data elements have been processed. A positive value causes the iterator to immediately return that positive value, indicating short-circuit success. A negative value causes the iterator to immediately return that value, indicating failure.</returns>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate herr_t operator_t(size_t elem, hid_t type_id, uint ndim, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] hsize_t[] point, size_t op_data);

    /// <summary>
    /// Delegate for <see cref="scatter"/>.
    /// <para>See <see href="https://support.hdfgroup.org/HDF5/doc/RM/RM_H5D.html#Dataset-Scatter" /> for further reference.</para>
    /// </summary>
    /// <param name="src_buf">Pointer to the buffer holding the next set of elements to scatter.</param>
    /// <param name="src_buf_bytes_used">Pointer to the number of valid bytes in <paramref name="src_buf"/>.</param>
    /// <param name="op_data">User-defined pointer to data required by the callback function.</param>
    /// <returns>The callback function should return zero (0) to indicate success, and a negative value to indicate failure.</returns>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate herr_t scatter_func_t(ref size_t src_buf /*out*/, ref size_t src_buf_bytes_used /*out*/, size_t op_data);
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dclose"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    ...
    public static hid_t create(hid_t loc_id, nint name, hid_t type_id, hid_t space_id) => create(loc_id, name, type_id, space_id, H5P.DEFAULT, H5P.DEFAULT, H5P.DEFAULT);
    ...
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t create(hid_t loc_id, nint name, hid_t type_id, hid_t space_id, hid_t lcpl_id) => create(loc_id, name, type_id, space_id, lcpl_id, H5P.DEFAULT, H5P.DEFAULT);
    ...
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t create(hid_t loc_id, nint name, hid_t type_id, hid_t space_id, hid_t lcpl_id, hid_t dcpl_id) => create(loc_id, name, type_id, space_id, lcpl_id, dcpl_id, H5P.DEFAULT);
    ...
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dcreate2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial hid_t create(hid_t loc_id, nint name, hid_t type_id, hid_t space_id, hid_t lcpl_id, hid_t dcpl_id, hid_t dapl_id);
    ...
    /// </summary>
    /// <param name="file_id">Identifier of the file or group within which to create the dataset.</param>
    /// <param name="type_id">Identifier of the datatype to use when creating the dataset.</param>
    /// <param name="space_id">Identifier of the dataspace to use when creating the dataset.</param>
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t create_anon(hid_t file_id, hid_t type_id, hid_t space_id) => create_anon(file_id, type_id, space_id, H5P.DEFAULT, H5P.DEFAULT);
    ...
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t create_anon(hid_t file_id, hid_t type_id, hid_t space_id, hid_t dcpl_id) => create_anon(file_id, type_id, space_id, dcpl_id, H5P.DEFAULT);
    ...
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dcreate_anon"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial hid_t create_anon(hid_t file_id, hid_t type_id, hid_t space_id, hid_t dcpl_id, hid_t dapl_id);
    ...
    /// <param name="buf">Pointer to the memory buffer containing the selection to be filled.</param>
    /// <param name="buf_type">Datatype of dataspace elements to be filled.</param>
    /// <param name="space">Dataspace describing memory buffer and containing the selection to be filled.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dfill"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t fill(size_t fill, hid_t fill_type, size_t buf, hid_t buf_type, hid_t space);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dflush"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <para>See <see href="https://support.hdfgroup.org/HDF5/doc/RM/RM_H5D.html#Dataset-Gather" /> for further reference.</para>
    /// </summary>
    /// <param name="src_space_id">Identifier for the dataspace describing both the dimensions of the source buffer and the selection within the source buffer to gather data from.</param>
    /// <param name="src_buf">Source buffer which the data will be gathered from.</param>
    /// <param name="type_id"> Identifier for the datatype describing the data in both the source and definition buffers. This is only used to calculate the element size.</param>
    /// <param name="dst_buf_size">Size in bytes of <paramref name="dst_buf"/>.</param>
    /// <param name="dst_buf">Destination buffer where the gathered data will be placed.</param>
    /// <param name="op">Callback function which handles the gathered data. Optional if <paramref name="dst_buf"/> is large enough to hold all of the gathered data; required otherwise.</param>
    /// <param name="op_data">User-defined pointer to data required by <paramref name="op"/>.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dgather"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t gather(hid_t src_space_id, size_t src_buf, hid_t type_id, size_t dst_buf_size, size_t dst_buf, gather_func_t op, size_t op_data);
    ...
    /// </summary>
    /// <param name="dset_id">Identifier of the dataset to get access property list of.</param>
    /// <returns>Returns a dataset access property list identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_access_plist"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <para>See <see href="https://portal.hdfgroup.org/display/HDF5/H5D_GET_CHUNK_INFO" /> for further reference.</para>
    /// </summary>
    ...
    /// <param name="offset">Pointer to a one-dimensional array with a size equal to the dataset's rank.</param>
    /// <param name="filter_mask"> Filter mask that indicates which filters were used with the chunk when written.</param>
    /// <param name="addr">Chunk address in the file.</param>
    /// <param name="size">Chunk size in bytes.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_chunk_info"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_chunk_info(hid_t dset_id, hid_t fspace_id, hsize_t index, hsize_t* offset, ref uint32_t filter_mask, ref haddr_t addr, ref hsize_t size);
    ...
    /// <param name="fspace_id">File dataspace selection identifier.</param>
    /// <param name="index">Chunk index in the selection.</param>
    /// <param name="offset">Reference to a one-dimensional array with a size equal to the dataset's rank.</param>
    /// <param name="filter_mask"> Filter mask that indicates which filters were used with the chunk when written.</param>
    /// <param name="addr">Chunk address in the file.</param>
    /// <param name="size">Chunk size in bytes.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    ...
    /// <param name="size">Chunk size in bytes.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_chunk_info_by_coord"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_chunk_info_by_coord(hid_t dset_id, hsize_t* offset, ref uint32_t filter_mask, ref haddr_t addr, ref hsize_t size);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_chunk_storage_size"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_chunk_storage_size(hid_t dset_id, hsize_t* offset, ref hsize_t chunk_bytes);
    ...
    /// </summary>
    /// <param name="dset_id">Identifier of the dataset to query.</param>
    /// <returns>Returns a dataset creation property list identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_create_plist"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// </summary>
    /// <param name="dset_id">Dataset identifier.</param>
    /// <returns>Returns the offset in bytes; otherwise returns <see cref="H5.HADDR_UNDEF"/>, a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_offset"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_space"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dget_space_status"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t get_space_status(hid_t dset_id, ref space_status_t allocation);
    ...
    /// <para>See <see href="https://support.hdfgroup.org/HDF5/doc/RM/RM_H5D.html#Dataset-Iterate" /> for further reference.</para>
    /// </summary>
    /// <param name="buf">Pointer to the buffer in memory containing the elements to iterate over.</param>
    /// <param name="type_id">Datatype identifier for the elements stored in <paramref name="buf"/>.</param>
    /// <param name="space_id">Dataspace identifier for <paramref name="buf"/>.</param>
    /// <param name="op">Function pointer to the routine to be called for each element in buf iterated over.</param>
    /// <param name="op_data">Pointer to any user-defined data associated with the operation.</param>
    /// <returns>Returns the return value of the last operator if it was non-zero, or zero if all elements have been processed. Otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Diterate"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t iterate(size_t buf, hid_t type_id, hid_t space_id, operator_t op, size_t op_data);
    ...
    /// <param name="name">Dataset name.</param>
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    public static hid_t open(hid_t file_id, nint name) => open(file_id, name, H5P.DEFAULT);
    ...
    /// <param name="dapl_id">Dataset access property list.</param>
    /// <returns>Returns a dataset identifier if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dopen2"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial hid_t open(hid_t file_id, nint name, hid_t dapl_id);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dread"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.HighLevelApisDllFilename, EntryPoint = "H5Dread_chunk"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Drefresh"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <para>See <see href="https://support.hdfgroup.org/HDF5/doc/RM/RM_H5D.html#Dataset-Scatter" /> for further reference.</para>
    /// </summary>
    /// <param name="op">Callback function which provides data to be scattered.</param>
    /// <param name="op_data">User-defined pointer to data required by op.</param>
    /// <param name="type_id">Identifier for the datatype describing the data in both the source and definition buffers. This is only used to calculate the element size.</param>
    /// <param name="dst_space_id">Identifier for the dataspace describing both the dimensions of the destination buffer and the selection within the destination buffer that data will be scattered to.</param>
    /// <param name="dst_buf">Destination buffer which the data will be scattered to.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dscatter"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t scatter(scatter_func_t op, size_t op_data, hid_t type_id, hid_t dst_space_id, size_t dst_buf);
    ...
    /// </summary>
    /// <param name="dset_id">Dataset identifier.</param>
    /// <param name="size">Array containing the new magnitude of each dimension of the dataset.</param>
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dset_extent"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    ...
    /// <param name="type_id">Datatype identifier.</param>
    /// <param name="space_id">Dataspace identifier.</param>
    /// <param name="size">The size in bytes of the memory buffer required to store the VL data.</param>
    /// <returns>Returns non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dvlen_get_buf_size"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t vlen_get_buf_size(hid_t dataset_id, hid_t type_id, hid_t space_id, ref hsize_t size);
    ...
    /// <returns>Returns a non-negative value if successful; otherwise returns a negative value.</returns>
    [LibraryImport(Constants.MainLibraryDllFilename, EntryPoint = "H5Dwrite"), SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial herr_t write(hid_t dset_id, hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, size_t buf);
